...
<!-- 				<button class="btn btn-success" type="button" style="margin-right: 50px;" onclick="javascript:window.location='drug?action=preSave1'">添加</button> -->
...
<!-- 					<th>操作</th> -->
				...
				<tbody>
				<c:forEach  varStatus="i" var="item" items="${drugList }">
					<tr>
...
<%-- 						<td>${student.tel }</td> --%>
<%-- 						<td><button class="btn btn-mini btn-info" type="button" onclick="javascript:window.location='drug?action=preSave1&studentId=${item.drugId }'">修改</button>&nbsp; --%>
<%-- 							<button class="btn btn-mini btn-danger" type="button" onclick="drugDelete(${item.drugId })">删除</button></td> --%>
					</tr>
				</c:forEach>
				</tbody>
			</table>
